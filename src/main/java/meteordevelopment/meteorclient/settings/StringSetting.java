...
public class StringSetting extends Setting<String> {
    ...
    public static class StringSettingImmutable extends StringSetting {
        public StringSettingImmutable(String name, String description, String defaultValue, Consumer<String> onChanged, Consumer<Setting<String>> onModuleActivated, IVisible visible, String placeholder, Class<? extends WTextBox.Renderer> renderer, CharFilter filter, boolean wide) {
            super(name, description, defaultValue, onChanged, onModuleActivated, visible, placeholder, renderer, filter, wide);
        }
        ...
        public static class Builder extends SettingBuilder<StringSettingImmutable.Builder, String, StringSettingImmutable> {
            ...
            public StringSettingImmutable build() {
                return new StringSettingImmutable(name, description, defaultValue, onChanged, onModuleActivated, visible, placeholder, renderer, filter, wide);
            }
        }
    }
}
